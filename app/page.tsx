...
import { HeroParallaxField, HeroMockup } from "@/components/landing/hero-visual"
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans">
      ...
      {/* Hero Section */}
      <section className="relative flex flex-col items-center text-center px-6 pt-[100px] pb-[80px] gap-6 max-w-[1100px] mx-auto overflow-hidden">
        <HeroParallaxField />

        <div className="relative flex flex-col items-center gap-6 max-w-[760px] mx-auto">
      ...
      <section className="px-6 md:px-10 py-10 md:pb-20 max-w-[1100px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <ScrollReveal className="md:col-span-2 bg-card border border-border rounded-xl p-7 transition-all hover:border-primary hover:shadow-md hover:-translate-y-[1px]">
          ...
          <ScrollReveal delay={0.1} className="bg-card border border-border rounded-xl p-7 transition-all hover:border-primary hover:shadow-md hover:-translate-y-[1px]">
          ...
          <ScrollReveal delay={0.15} className="bg-card border border-border rounded-xl p-7 transition-all hover:border-primary hover:shadow-md hover:-translate-y-[1px]">
          ...
          <ScrollReveal delay={0.2} className="bg-card border border-border rounded-xl p-7 transition-all hover:border-primary hover:shadow-md hover:-translate-y-[1px]">
          ...
          <ScrollReveal delay={0.25} className="bg-card border border-border rounded-xl p-7 transition-all hover:border-primary hover:shadow-md hover:-translate-y-[1px]">
